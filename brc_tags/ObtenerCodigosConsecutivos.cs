...
namespace brc_tags
{
    public partial class ObtenerCodigosConsecutivos : Form
    {
        ...
        public ObtenerCodigosConsecutivos()
        {
            InitializeComponent();
        }

        private void ObtenerCodigosConsecutivos_Load(object sender, EventArgs e)
        {
